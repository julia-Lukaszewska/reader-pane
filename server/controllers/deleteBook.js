...
import { deleteFromBucket } from '../setupGridFS.js'
...
/**
 * DELETE /api/books/:id
 * Deletes a book and its associated file from the system.
 *
 * @param {Object} req - Express request object (expects req.user and req.params.id)
