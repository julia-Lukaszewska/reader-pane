 ...
 * - file: GridFS reference (filename + ObjectId)
...
const bookSchema = new mongoose.Schema(
  {
    ...
    // -------------------------------------------------------------------------
    file: {
      filename: { type: String, required: true },                   // Descriptive name in GridFS
      fileId:   { type: mongoose.Types.ObjectId, required: true },  // ObjectId in fs.files
    },
